...
export type CreateHabitMutation = { __typename?: 'Mutation', createHabit: { __typename?: 'Habit', id: string, name: string, description: string, tooHard: boolean, habitRecords: Array<{ __typename?: 'HabitRecord', id: string, date: string, status: HabitRecordStatus, habitId: string }> } };
